...
export default function FinancialSalem() {
  return (
    <ServiceLayout
      seo={{
        title: "Outsourced financial controller services in Salem | Milta",
        description:
          "Transform your financial operations with outsourced financial controller services in Salem. Certified experts ready to elevate your business.",
        keywords:
          "financial controller services, outsourced financial controller, accounting controller, certified financial controller",
        author: "Milta Accounting",
        canonical: "https://www.miltafs.com/us/services/financial-controller-services-in-salem/",
        schema: faqSchema,
      }}
      hero={{
        titleLead: "Take Control of Your Business Finances with",
        highlight: "Controller Services in Salem",
        subtitle:
        ...
        breadcrumb: "Financial Controller Services in Salem",
      }}
      intro={{
        overline: "",
        ...
        ctaLabel: "Schedule Your Free Consultation Today.",
        imageAlt: "Financial controller services in Salem",
      }}
      prose={{
        overline: "",
      ...
      cardGroups={[
        {
          ...
          highlight: "Services?",
          paragraphs: [
            "Certified Financial Controller Services in Salem: Optimize Your Financial Operations",
