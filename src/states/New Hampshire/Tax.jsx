...
- Miscellaneous income (jury duty, gambling winnings, Medical Savings Accounts, scholarships, etc.)`,
  },
  {
    ...
    a: "Yes, we provide complete tax preparation services in New Hampshire for federal, state, and city taxes, ensuring compliance at all levels.",
  },
  {
...
export default function TaxNewHampshire() {
  return (
    <ServiceLayout
      seo={{
        title: "Tax planning & preparation services in New Hampshire | Milta",
        description:
          "Reliable tax preparation services in New Hampshire for federal, state & city filings — forms 1040, 1041, 1065, 1120, 1120s & 990. Contact us today.",
        keywords:
          "tax services near me, tax preparation services in New Hampshire, accounting firm near me, tax planning and preparation, New Hampshire tax preparation",
        author: "Milta Accounting",
        canonical: "https://www.miltafs.com/us/services/tax-planning-and-preparation-service-in-newhampshire/",
        schema: faqSchema,
      }}
      hero={{
        ...
        },
        {
          ...
          items: [
            ...
            },
            {
              ...
              desc: "Ensure adherence to the latest IRS guidelines (e.g., R&D tax credit changes) and New Hampshire-specific rules.",
            },
            {
