...
export default function FinancialMontana() {
  return (
    <ServiceLayout
      seo={{
        title: "Outsourced financial controller services in Montana | Milta",
        description:
          "Transform your financial operations with outsourced financial controller services in Montana. Certified experts ready to elevate your business.",
        keywords:
          "financial controller services, outsourced financial controller, accounting controller, certified financial controller.",
        author: "Milta Accounting",
        canonical: "https://www.miltafs.com/us/services/financial-controller-services-in-montana/",
        schema: faqSchema,
      }}
      hero={{
        titleLead: "Take Control of Your Business Finances with",
        highlight: "Controller Services in Montana",
        subtitle:
        ...
        breadcrumb: "Financial Controller Services in Montana",
      }}
      intro={{
        ...
        ctaLabel: "Schedule Your Free Consultation Today.",
        imageAlt: "Financial controller services in Montana",
      }}
      prose={{
      ...
      cardGroups={[
        {
          ...
          titleLead: "Certified Financial Controller Services in Montana:",
