...
export default function DataEntryWashington() {
  return (
    <ServiceLayout
      seo={{
        title: "Accounting data entry services in Washington | Milta ",
        description:
          "Partner with a leading data entry company in Washington for accurate accounting data entry & data management services that cut costs",
        keywords:
          "data entry companies, accounting data entry, data entry services, data management services.",
        author: "Milta Accounting",
        canonical:
          "https://www.miltafs.com/us/services/outsourcing-accounting-data-entry-washington/",
        schema: faqSchema,
      }}
      hero={{
