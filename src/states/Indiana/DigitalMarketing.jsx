  ...
  return (
    <ServiceLayout
      ...
      hero={{
        ...
        subtitle:
          "Unlock Explosive Growth Using Cutting-Edge Digital Marketing Services in Indiana",
      ...
      whyEssential={{
        ...
        footnote:
          "At Milta, we don't just boost visibility, we deliver measurable results for businesses across Indiana. Let us help you strengthen your brand, accelerate growth, and dominate your industry.",
      }}
      cardGroups={[
        {
          overline: "",
        ...
        },
        {
          ...
          items: [
            {
              ...
              desc: "Milta provides a full suite of digital marketing services in Indiana, including SEO, PPC, Social Media Marketing, Email Marketing, and Content Creation. Whether your goal is to increase website traffic, generate leads, or boost brand visibility, our team has the expertise to deliver results.",
            },
            {
              title: "Expert Team",
              desc: "Our dedicated team of Indiana internet marketing professionals brings years of experience and knowledge to each project. We stay updated on the latest trends and tools to ensure your campaigns are optimized for success.",
            },
            {
          ...
          footnote:
            "By choosing Milta as your digital marketing agency in Indiana, you're partnering with a team committed to your business's growth and success, with the best strategies and a proven track record of delivering results.",
        },
        {
          overline: "",
