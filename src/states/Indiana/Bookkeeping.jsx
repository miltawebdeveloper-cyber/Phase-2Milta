...
const bookkeepingItems = [
  ["1. Bank and Credit Card Reconciliation", "Ensuring your financial records match your bank and credit card statements is crucial. Our team meticulously reconciles every transaction, eliminating discrepancies and safeguarding against errors or fraud. Regular reconciliation also helps identify unnecessary charges or mistakes, keeping your accounts accurate and secure."],
  ["2. Management of Cash Flow, Receivables (AR), and Accounts Payable (AP)", "Effective cash flow management is vital for the sustainability of your business. We track and document your cash inflows and outflows, manage AR to monitor outstanding payments, and handle AP to ensure vendor bills are paid on time. This gives you a clear, real-time view of your financial health."],
  ["3. Invoice Generation and Payment Tracking", "Invoicing can be time-consuming, but it's essential for maintaining a steady cash flow. We handle invoice creation, ensure timely payment recording, and follow up on overdue payments. Our streamlined process guarantees that your income is tracked accurately and efficiently."],
  ["4. Chart of Accounts and Accounting System Setup", "A well-structured chart of accounts is the foundation of sound financial management. We work with you to create a customized chart of accounts that categorizes transactions clearly. Additionally, we maintain an organized accounting system, ensuring all documents are easily accessible when needed."],
  ["5. Payroll Processing, Tax Compliance, and Employee Benefits Management", "Payroll is a critical function that requires precision and compliance. We manage payroll calculations, tax withholdings, and employee benefits, ensuring your team is paid accurately and on time while adhering to all tax regulations."],
  ["6. Customized Financial Reporting (Weekly, Monthly, Yearly)", "Regular financial reports are key to understanding your business's performance. We provide weekly, monthly, and yearly reports customized to your needs, offering insights into revenue, expenses, profits, and other vital metrics. These reports empower you to make informed decisions and drive growth."],
  ["7. Small Business Accounting, Non-Profit Bookkeeping, and Financial Clean-Up", "Whether you're a small business or a non-profit, we specialize in managing your unique financial needs. We also offer financial clean-up services to reorganize and streamline your financial records, helping you regain control of your finances."],
  ["8. CPA Collaboration for Year-End Tax Preparation", "We work closely with certified public accountants (CPAs) to ensure your year-end tax filings are accurate and timely. By preparing and organizing your financial records, we simplify the process for your CPA, allowing you to focus on running your business."],
];
  ...
  return (
    <ServiceLayout
      ...
      hero={{
        ...
        subtitle: "With over 15+ years of experience, our bookkeeping company in Indiana specializes in providing expert bookkeeping services for small businesses in Indiana and surrounding areas. Contact us today for trusted bookkeeping services in Indiana and let us handle your finances with care and expertise.",
        breadcrumb: "Bookkeeping Services in Indiana",
      }}
      intro={{
        overline: "BEST SOLUTION IN INDIANA",
        titleLead: "The Best Bookkeeping Services for Small Businesses in",
        highlight: "Indiana",
        paragraphs: [
          "As a leading bookkeeping company in Indiana, Milta ensures your financial records are organized, accurate, and easy to manage. Our skilled NY bookkeepers provide the best bookkeeping for small business, transforming complex financial data into clear insights to help you maintain control over your business's financial health.",
        ...
        imageAlt: "Bookkeeping services for small businesses in Indiana",
      }}
      prose={{
      ...
      cardGroups={[{
        ...
        bg: "paper",
        columns: 2,
        items: bookkeepingItems.map(([title, desc]) => ({ title, desc })),
