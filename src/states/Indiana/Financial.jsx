  ...
  return (
    <ServiceLayout
      seo={{
        ...
        description:
          "Transform your financial operations with outsourced financial controller services in Indiana. Certified experts ready to elevate your business.",
        keywords:
      ...
      hero={{
        ...
        highlight: "Controller Services in Indiana",
        subtitle:
      ...
      cardGroups={[
        {
          ...
          highlight: "Services?",
          paragraphs: [
            "Certified Financial Controller Services in Indiana: Optimize Your Financial Operations",
