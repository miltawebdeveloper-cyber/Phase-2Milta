...
const faqs = [
  ...
  { q: "Do you offer payroll and bookkeeping services together?", a: "Yes, we provide comprehensive payroll and bookkeeping services in North Carolina, USA, ensuring your employees are paid accurately and on time while keeping your financial records organized and up to date." },
  ...
  { q: "Is my business too small to hire a bookkeeping company in North Carolina?", a: "No business is too small for bookkeeping services in North Carolina. Accurate financial management is especially important for small businesses to monitor cash flow, prepare for taxes, and plan for growth. Our services are affordable and scalable to meet your needs." },
...
export default function BookkeepingNorthCarolina() {
  return (
    <ServiceLayout
      seo={{
      ...
      hero={{
        ...
        subtitle:
          "With over 10+ years of experience, our bookkeeping company in North Carolina specializes in delivering the best bookkeeping for small businesses. Contact us today for trusted bookkeeping services in North Carolina.",
        breadcrumb: "Bookkeeping Services in North Carolina",
      }}
      intro={{
        ...
        imageAlt: "Bookkeeping services for small businesses in North Carolina",
      }}
      whyEssential={{
