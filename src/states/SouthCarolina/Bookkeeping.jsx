...
const faqs = [
  ...
  { q: "Do you offer payroll and bookkeeping services together?", a: "Yes, we provide comprehensive payroll and bookkeeping services in South Carolina, USA, ensuring your employees are paid accurately and on time while keeping your financial records organized and up-to-date." },
  ...
  { q: "Is my business too small to hire a bookkeeping company in South Carolina?", a: "No business is too small for bookkeeping services in South Carolina. Accurate financial management is especially important for small businesses to monitor cash flow, prepare for taxes, and plan for growth. Our services are designed to be affordable and scalable to meet your needs." },
...
export default function BookkeepingSouthCarolina() {
  return (
    <ServiceLayout
      seo={{
      ...
      hero={{
        ...
        breadcrumb: "Bookkeeping Services in South Carolina",
      }}
      intro={{
        overline: "BOOKKEEPING SERVICES",
        titleLead: "Unrivaled Bookkeeping Services for Small Businesses in",
        ...
        imageAlt: "Bookkeeping services for small businesses in South Carolina",
      }}
      whyEssential={{
