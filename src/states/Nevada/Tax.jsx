...
const faqs = [
  ...
  {
    q: "What documents are required for tax preparation services in Nevada?",
    a: `To ensure accurate and complete tax preparation service in Nevada, USA, you'll need to provide the following documents:
...
- Miscellaneous income (jury duty, gambling winnings, Medical Savings Accounts, scholarships, etc.)`,
  },
  {
    ...
    a: "Yes, we provide complete tax preparation services in Nevada for federal, state, and city taxes, ensuring compliance at all levels.",
  },
  {
...
export default function TaxNevada() {
  return (
    <ServiceLayout
      seo={{
        title: "Tax planning & preparation services in Nevada | Milta",
        description:
          "Reliable tax preparation services in Nevada for federal, state & city filings — forms 1040, 1041, 1065, 1120, 1120s & 990. Contact us today.",
        keywords:
          "tax services near me, tax preparation services in Nevada, accounting firm near me, tax planning and preparation, Nevada tax preparation.",
        author: "Milta Accounting",
        canonical: "https://www.miltafs.com/us/services/tax-planning-and-preparation-service-in-nevada/",
        schema: faqSchema,
      }}
      hero={{
        titleLead: "Optimize Your Tax Filing with Trusted",
        highlight: "Tax Preparation Services in Nevada!",
        subtitle:
        ...
        breadcrumb: "Tax Services in Nevada",
      }}
      intro={{
        overline: "TAX PLANNING IN NEVADA",
        ...
        paragraphs: [
          ...
          "At Milta, we provide professional tax preparation services in Nevada, offering proactive strategies to ensure compliance and maximize tax savings. If you're searching for tax services near me, partner with us for expert financial support not just during tax season, but throughout your business journey.",
        ],
        ctaLabel: "Get Started Today with a Free Consultation!",
        imageAlt: "Tax preparation services in Nevada",
      }}
      prose={{
      ...
      cardGroups={[
        {
          ...
          highlight: "Nevada",
          subtitle:
            "We handle every aspect of Nevada tax preparation, transforming complex financial data into accurate, compliant returns. Our goal is to minimize your tax liability and maximize refunds while ensuring full adherence to federal, state, and local regulations.",
          bg: "paper",
          columns: 2,
          items: [
            {
            ...
            {
              title: "State Nevada Tax Preparation — Business Taxes",
              desc: "Nevada levies no personal or corporate income tax, so we focus on what you do owe: Commerce Tax returns for businesses above the $4 million gross revenue threshold, and Modified Business Tax (payroll) filings.",
            },
            {
              title: "State Nevada Tax Preparation — Sales Tax",
              desc: "Compliance with Nevada's 6.85% statewide sales and use tax rate plus county add-ons, exemptions, and monthly or quarterly reporting for retailers.",
            },
            {
              title: "State Nevada Tax Preparation — Property Tax",
            ...
            },
            {
              ...
              desc: "We decode local tax rules for cities like Las Vegas, Reno, and Henderson, addressing nuances such as business personal property taxes, county sales tax add-ons, and city licensing fees.",
            },
          ],
        },
        {
          ...
          items: [
            ...
            },
            {
              ...
              desc: "Ensure adherence to the latest IRS guidelines (e.g., R&D tax credit changes) and Nevada-specific rules.",
            },
            {
        ...
        },
        {
          ...
          items: [
            ...
            },
            {
              ...
              desc: "Federal (IRS), the Nevada Department of Taxation, and local portals.",
            },
            {
      ...
      checklists={[
        {
          ...
          items: [
            ...
            "Nevada-Specific Knowledge: Deep familiarity with state tax incentives (e.g., film production credits, renewable energy tax abatements).",
            "Proactive Compliance: We monitor law changes (e.g., Commerce Tax and Modified Business Tax updates) to keep you ahead.",
      ...
      closing={{
        ...
        bg: "paper",
        paragraphs: [
          "If you're looking for tax services near me, our tax preparation services in Nevada ensure accuracy and compliance every step of the way.",
