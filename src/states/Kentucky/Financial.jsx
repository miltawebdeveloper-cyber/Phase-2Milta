...
const capabilityRows = [
  ["Accounting Function Oversight", true, true], ["Regulatory Compliance (GAAP, etc.)", true, true], ["ERP Implementation", true, true],
  ["Management Accounting", true, true], ["Accounting Internal Controls", true, true], ["Closing Entries (Financial Close)", true, true],
  ["Budgeting & Forecasting Support", true, true], ["Cash Flow Management", true, true], ["Financial Reporting & Analysis", true, true],
  ["Financial Statement Preparation/Review", true, true], ["Team Management, Hiring & Training", true, true],
  ["Long-Term Business & Financial Strategy", false, true], ["Fundraising & Investor Relations", false, true], ["Investment Advisory", false, true],
];
  ...
  return (
    <ServiceLayout
      seo={{
        ...
        description: "Transform your financial operations with outsourced financial controller services in Kentucky. Certified experts ready to elevate your business.",
      ...
      hero={{
        titleLead: "Strengthen Your Business Finances with Trusted",
        highlight: "Financial Controller Services in Kentucky",
        subtitle: "Gain accurate reporting, stronger internal controls, and practical financial guidance from an experienced controller team built for growing Kentucky businesses.",
        ctaLabel: "Schedule Your Free Financial Consultation",
      ...
      prose={{
        ...
        titleLead: "Certified Financial Controller Services in Kentucky:",
