...
export default function FinancialNewMexico() {
  return (
    <ServiceLayout
      seo={{
        title: "Outsourced financial controller services in New Mexico | Milta",
        description:
          "Transform your financial operations with outsourced financial controller services in New Mexico. Certified experts ready to elevate your business.",
        keywords:
          "financial controller services, outsourced financial controller, accounting controller, certified financial controller.",
        author: "Milta Accounting",
        canonical: "https://www.miltafs.com/us/services/financial-controller-services-in-newmexico/",
        schema: faqSchema,
      }}
      hero={{
        titleLead: "Take Control of Your Business Finances with",
        highlight: "Controller Services in New Mexico",
        subtitle:
        ...
        breadcrumb: "Financial Controller Services in New Mexico",
      }}
      intro={{
        ...
        ctaLabel: "Schedule Your Free Consultation Today.",
        imageAlt: "Financial controller services in New Mexico",
      }}
      prose={{
      ...
      cardGroups={[
        {
          ...
          titleLead: "Certified Financial Controller Services in New Mexico:",
