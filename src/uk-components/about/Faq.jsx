// src/uk-components/about/Faq.jsx
...
// Exported so the About page can build its FAQPage schema from the exact same
// data it renders — the markup can never drift from the visible copy.
export const faqs = [
  {
    id: "panel1",
  ...
  return (
    <Box sx={{ pt: { xs: 8, md: 6 }, pb: { xs: 8, md: 12 }, bgcolor: "#fff" }}>
      ...
      >
        ...
        >
          Everything You Need to Know About Milta
        </Typography>
