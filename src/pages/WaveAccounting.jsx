...
const chips = ["Free Software", "Invoicing", "Freelancers", "Startups"];
    ...
    >
      ...
      <Container maxWidth="lg" sx={{ position: "relative", zIndex: 1 }}>
        ...
        <Box component={motion.div} {...fadeUp(0.05)} sx={{ mb: { xs: 8, md: 11 } }}>
          <SectionHeading>Why Wave Accounting Works Well for Smaller Firms</SectionHeading>
        ...
        <Box component={motion.div} {...fadeUp(0.05)} sx={{ mb: { xs: 8, md: 11 }, maxWidth: 940, mx: "auto" }}>
          <SectionHeading>How We Use Wave for US Clients</SectionHeading>
