...
const QuickBooksOnlineModernHybrid = () => {
  ...
  const COLORS = {
    ...
    accentSoft: alpha(theme.palette.primary.main, 0.08),
      ...
      <Container maxWidth="lg" sx={{ position: "relative", zIndex: 1 }}>
        ...
        <Box component={motion.div} {...fadeUp(0)} sx={{ textAlign: "center", mb: { xs: 7, md: 9 } }}>
          ...
          <Box sx={{ display: "flex", flexWrap: "wrap", justifyContent: "center", gap: 1.25, mt: 4 }}>
            {["Simple Start", "Essentials", "Plus", "Advanced"].map((v) => (
              <Box
                key={v}
                sx={{
                  px: 2,
        ...
        <Box component={motion.div} {...fadeUp(0.05)} sx={{ mb: { xs: 8, md: 11 } }}>
          <SectionHeading>Why US Businesses Prefer QuickBooks Online</SectionHeading>
          ...
          {/* TARGET BUSINESSES */}
          <Typography align="center" maxWidth={820} mx="auto" mt={5} color={COLORS.textMuted} sx={{ lineHeight: 1.85 }}>
        ...
        <Box component={motion.div} {...fadeUp(0.05)} sx={{ mb: { xs: 8, md: 11 }, maxWidth: 940, mx: "auto" }}>
          <SectionHeading>How We Manage Your Books in QuickBooks Online</SectionHeading>
