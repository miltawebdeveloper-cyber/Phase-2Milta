...
const POINTS = [
  'Domain Expertise: requires specialized knowledge of financial terminology, bookkeeping, and US GAAP compliance standards.',
  'Accuracy Focus: double-entry verification and reconciliation minimize compliance risks and costly financial errors.',
  'Customized Solutions: services tailored for small business needs with personalized attention and industry-specific insights.',
  'US GAAP Compliance: every financial transaction is aligned with US accounting standards for seamless audits.',
];
          ...
          <Box sx={{ flex: 1 }}>
            ...
            <motion.div {...fadeUp(0.1)}>
              <Typography variant="h2" sx={{ fontSize: { xs: '1.9rem', md: '2.8rem' }, lineHeight: 1.2, mb: 2.5 }}>
                What is Accounting Data Entry and{' '}
                <Box component="span" sx={{ color: primary }}>How It Differs from Other Services?</Box>
              </Typography>
            </motion.div>
            <motion.div {...fadeUp(0.18)}>
              ...
              <Typography sx={{ color: 'text.secondary', fontSize: '1rem', lineHeight: 1.85, fontFamily: '"Outfit", sans-serif', mb: 2 }}>
                Welcome to Milta — your trusted partner for accurate and reliable accounting data entry services tailored for small and medium-scale businesses across the USA. We deliver efficient, affordable, and high-quality data entry solutions to simplify your operations and keep your records precise, compliant, and up-to-date.
              </Typography>
              <Typography sx={{ color: 'text.secondary', fontSize: '0.97rem', lineHeight: 1.85, fontFamily: '"Outfit", sans-serif', mb: 3, fontWeight: 600 }}>
                Unlike general data entry, accounting data entry demands specialized knowledge. Here's how we stand apart:
              </Typography>
            </motion.div>
            <Stack spacing={1.5}>
              {POINTS.map((point, i) => (
