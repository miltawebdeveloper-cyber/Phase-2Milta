...
const SERVICES = [
  { icon: AccountBalanceIcon, title: 'Federal Tax Preparation',              desc: 'IRS-compliant filing of Form 1040, 1120, 1120S, 1041, and more — all deductions and credits accurately applied to minimize your federal liability.' },
  { icon: MapIcon,            title: 'State Tax Preparation',                desc: 'State-specific income, property, and sales tax filings. We stay current on changing state regulations to ensure compliance and optimized tax positions.' },
  { icon: LocationCityIcon,   title: 'City Tax Preparation',                 desc: 'Accurate filings addressing nuances in municipal tax codes — ensuring your business meets all local government tax obligations.' },
  { icon: FactCheckIcon,      title: 'Tax Review & Finalization',             desc: 'Meticulous examination of every return — verifying calculations, confirming deductions, correcting discrepancies, and gathering approvals before submission.' },
  { icon: SendIcon,           title: 'Tax E-Filing',                         desc: 'Secure electronic submission to IRS, state, and local authorities for faster processing, reduced errors, quicker refunds, and no physical mailing.' },
  { icon: PersonIcon,         title: 'Individual & Trust Returns',            desc: 'Form 1040 for individuals with all wages, investments, and deductions; Form 1041 for estates and trusts ensuring fiduciary obligations are met.' },
  { icon: BusinessIcon,       title: 'Corporate Returns',                    desc: 'Form 1120 for C Corporations detailing income, expenses, and tax liabilities; Form 1120S for S Corporations reflecting pass-through income to shareholders.' },
  { icon: HandshakeIcon,      title: 'Partnership & Non-Profit Returns',     desc: 'Form 1065 for partnership profits, losses, and K-1 schedules; Form 990 for non-profits maintaining tax-exempt status; Form 1099 for contractors and freelancers.' },
];
        ...
        <Box sx={{ mb: { xs: 6, md: 8 }, textAlign: 'center' }}>
          ...
          <motion.div {...fadeUp(0.18)}>
            <Typography sx={{ color: 'text.secondary', fontSize: '1rem', lineHeight: 1.8, maxWidth: 560, mx: 'auto', mt: 2, fontFamily: '"Outfit", sans-serif' }}>
              From federal and state preparation to e-filing and complex entity returns — every service is designed to minimize your tax liability and maximize your refund.
            </Typography>
          </motion.div>
        </Box>
