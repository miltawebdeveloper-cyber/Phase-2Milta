...
const ADVANTAGES = [
  { icon: AttachMoneyIcon,        title: 'Significant Cost Savings',          desc: 'Outsourcing eliminates full-time salary, benefits, and overhead — access elite financial expertise at a fraction of the cost.' },
  { icon: WorkspacePremiumIcon,   title: 'Expert Financial Leadership',        desc: 'Gain access to senior-level controllers with deep experience across accounting, compliance, and financial strategy for SMBs.' },
  { icon: TrendingUpIcon,         title: 'Scalability on Demand',             desc: 'As your business grows or contracts, our services adapt seamlessly — you always have the right level of financial oversight.' },
  { icon: GavelIcon,              title: 'Enhanced Compliance',               desc: 'Stay current with US GAAP, federal and state regulations, and auditing standards — reducing risk of penalties and non-compliance.' },
  { icon: CenterFocusStrongIcon,  title: 'Focus on Core Business',            desc: 'Delegate complex financial operations to our experts and redirect your energy toward growing revenue and serving your customers.' },
];

const PANEL_STATS = [
  { num: '60–70%', label: 'Cost Reduction'    },
  { num: '95%+',   label: 'Compliance Rate'   },
            ...
            <Box sx={{
              ...
              <Box sx={{ position: 'relative', zIndex: 1 }}>
                ...
                <Typography variant="h2" sx={{ color: '#ffffff', fontSize: { xs: '1.75rem', md: '2.1rem' }, fontWeight: 900, lineHeight: 1.2, letterSpacing: '-0.02em', mb: 2.5 }}>
                  Why Outsource{' '}
                  <Box component="span" sx={{ color: alpha(primary, 0.9) }}>Financial Controller Services?</Box>
                </Typography>
                <Typography sx={{ color: alpha('#ffffff', 0.68), fontSize: '0.9rem', lineHeight: 1.8, mb: 4, fontFamily: '"Outfit", sans-serif' }}>
                  Businesses outsourcing their controller function save 60–70% versus a full-time hire — while gaining senior-level expertise, scalability, and full regulatory compliance.
                </Typography>
