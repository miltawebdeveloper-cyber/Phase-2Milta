...
const TRUST_POINTS = [
  { icon: AccountBalanceIcon, title: 'Accounting Oversight',    desc: 'Comprehensive management of all accounting functions — from transaction processing to financial close — keeping your books accurate and current.' },
  { icon: GavelIcon,          title: 'Regulatory Compliance',   desc: 'Full adherence to US GAAP, federal, and state financial regulations, minimizing audit risk and protecting your business from penalties.' },
  { icon: BarChartIcon,       title: 'Financial Reporting',     desc: 'Accurate and timely monthly, quarterly, and annual reports that give key stakeholders the insights needed for confident decision-making.' },
  { icon: SecurityIcon,       title: 'Internal Controls',       desc: 'Assessment and implementation of robust internal control mechanisms to safeguard financial integrity and prevent errors or fraud.' },
  { icon: TuneIcon,           title: 'Customized Solutions',    desc: 'Every engagement is tailored to your business size, industry, and financial goals — no generic packages, only what your business truly needs.' },
  { icon: FactCheckIcon,      title: 'Audit Support',           desc: 'End-to-end audit preparation assistance — organized documentation, compliance verification, and stakeholder communication throughout the process.' },
];
          ...
          <Box sx={{ textAlign: 'center', mb: { xs: 6, md: 8 } }}>
            ...
            <motion.div {...fadeUp(0.1)}>
              <Typography variant="h2" sx={{ fontSize: { xs: '2rem', md: '3rem' }, lineHeight: 1.2, color: '#ffffff', maxWidth: 720, mx: 'auto', letterSpacing: '-0.02em' }}>
                ...
                <Box component="span" sx={{ color: alpha(primary, 0.9) }}>Financial Controller Services in USA</Box>
              </Typography>
            </motion.div>
...
export default FCTrustedPartner;
