...
const HeroModern = ({ title = "Payroll Management Services", breadcrumbTitle = "Payroll Management" }) => {
      ...
      <Container maxWidth={false} sx={{ maxWidth: '1300px', mx: 'auto', position: 'relative', zIndex: 1 }}>
        <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center', py: { xs: 4, md: 0 } }}>
          ...
          >
            ...
            >
              Streamline payroll operations with accurate processing, timely tax filings, and full compliance with U.S. payroll regulations. Our payroll management services help businesses reduce errors, save time, and ensure employees are paid correctly—every time.
            </Typography>
          </motion.div>
          ...
          >
            ...
            >
              ...
              <Typography
                variant="body2"
                sx={{ color: alpha('#ffffff', 0.9), fontWeight: 600, letterSpacing: '0.02em' }}
              >
                {breadcrumbTitle}
              </Typography>
            </Breadcrumbs>
