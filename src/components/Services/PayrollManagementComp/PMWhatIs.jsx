...
const POINTS = [
  'Employee timesheet management and accurate calculation of wages, overtime, and paid leave — ensuring every employee is paid correctly and on time.',
  'Payroll tax calculation, payment, and filing — covering federal, state, and local authorities with automated, error-free remittances.',
  'Payslip generation and detailed payroll reporting — including labor cost analysis, headcount tracking, and leave balance reporting.',
  'Full compliance with US payroll laws and labor regulations — so your business avoids penalties and stays audit-ready year-round.',
];
          ...
          <Box sx={{ flex: 1 }}>
            ...
            <motion.div {...fadeUp(0.1)}>
              <Typography variant="h2" sx={{ fontSize: { xs: '1.9rem', md: '2.8rem' }, lineHeight: 1.2, mb: 2.5 }}>
                What is Payroll Management and{' '}
            ...
            <Box sx={{ position: 'relative', borderRadius: '24px', overflow: 'hidden', boxShadow: `0 32px 80px ${alpha(primary, 0.12)}` }}>
              ...
              <Box sx={{ position: 'absolute', bottom: 24, left: 24, right: 24, borderRadius: '16px', bgcolor: (t) => t.palette.mode === 'dark' ? 'rgba(25,42,27,0.95)' : 'rgba(255,255,255,0.95)', backdropFilter: 'blur(12px)', p: 2.5, boxShadow: '0 8px 32px rgba(0,0,0,0.12)' }}>
                <Stack direction="row" spacing={3} justifyContent="space-around">
                  {[{ num: '100+', label: 'Clients' }, { num: '5+', label: 'Countries' }, { num: '15y+', label: 'Experience' }].map(({ num, label }) => (
