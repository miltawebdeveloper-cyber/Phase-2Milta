...
const TRUST_POINTS = [
  { icon: PaymentsIcon,                 title: 'Accurate Payroll Processing',      desc: 'Every pay cycle is handled with precision — wages, deductions, overtime, and payslips calculated and delivered on schedule without errors.' },
  { icon: GavelIcon,                    title: 'Full Tax & Regulatory Compliance', desc: 'We stay current with federal, state, and local payroll regulations — filing taxes accurately and remitting payments to all authorities on time.' },
  { icon: AccessTimeIcon,               title: 'Time & Attendance Integration',    desc: 'Automated syncing of working hours, leave balances, and overtime data directly into payroll — eliminating manual entry and discrepancies.' },
  { icon: SecurityIcon,                 title: 'Payroll Data Security',            desc: 'Role-based access controls, encrypted data handling, identity protection tools, and continuous monitoring keep your payroll data secure at all times.' },
  { icon: BarChartIcon,                 title: 'Real-Time Payroll Reporting',      desc: 'Audit-ready reports, labor cost dashboards, and headcount analytics delivered on demand — giving management full visibility into payroll operations.' },
  { icon: IntegrationInstructionsIcon,  title: 'Software & ERP Integration',       desc: 'Seamless integration with QuickBooks, Gusto, ADP, Paychex, Xero, Zoho, and Odoo — connecting payroll with your existing business systems.' },
];
          ...
          <Box sx={{ textAlign: 'center', mb: { xs: 6, md: 8 } }}>
            ...
            <motion.div {...fadeUp(0.1)}>
              <Typography variant="h2" sx={{ fontSize: { xs: '2rem', md: '3rem' }, lineHeight: 1.2, color: '#ffffff', maxWidth: 720, mx: 'auto', letterSpacing: '-0.02em' }}>
                Why Milta Accounting is Your Trusted Partner for{' '}
                <Box component="span" sx={{ color: alpha(primary, 0.9) }}>Payroll Management Services in the USA</Box>
              </Typography>
            </motion.div>
            <motion.div {...fadeUp(0.18)}>
              <Typography sx={{ color: alpha('#fff', 0.6), fontSize: '1rem', lineHeight: 1.8, maxWidth: 580, mx: 'auto', mt: 2, fontFamily: '"Outfit", sans-serif' }}>
                With our expertise, advanced payroll system, and dedicated professionals — your payroll is handled efficiently so you can focus on growing your business.
              </Typography>
            </motion.div>
...
export default PMTrustedPartner;
