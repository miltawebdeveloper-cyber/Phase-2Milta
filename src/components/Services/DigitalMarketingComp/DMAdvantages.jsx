...
const ADVANTAGES = [
  { icon: PublicIcon,        title: 'Reach a Broader Audience',             desc: 'Connect with potential clients worldwide using targeted SEO, PPC, and social media strategies that put your message in front of the right people.' },
  { icon: SavingsIcon,       title: 'Cost-Effective Marketing',              desc: 'Digital marketing delivers better results at a lower cost than traditional channels — tailor your budget while achieving excellent ROI.' },
  { icon: PeopleIcon,        title: 'Engage More Clients',                   desc: 'Social media, email marketing, and personalized content foster direct engagement, building stronger client relationships and encouraging repeat business.' },
  { icon: EmojiEventsIcon,   title: 'Achieve High Search Rankings',          desc: 'Effective SEO techniques position your business at the top of Google and Bing — boosting visibility, organic traffic, and credibility.' },
  { icon: QueryStatsIcon,    title: 'Trackable & Measurable Results',        desc: 'Monitor campaign success in real time using Google Analytics and social media insights — measure, optimize, and continuously improve performance.' },
];

const PANEL_STATS = [
  { num: '3x',   label: 'More Leads'         },
  { num: '60%',  label: 'Lower Cost/Lead'    },
  { num: '24/7', label: 'Online Visibility'  },
  { num: '100+', label: 'Brands Grown'       },
];
    ...
    <Box sx={{ py: { xs: 8, md: 14 }, bgcolor: 'background.paper', overflow: 'hidden', position: 'relative' }}>
      <Container maxWidth={false} sx={{ maxWidth: '1300px', mx: 'auto', px: { xs: 3, md: 4 } }}>
        <Box sx={{ display: 'flex', flexDirection: { xs: 'column', lg: 'row' }, gap: { xs: 6, lg: 5 }, alignItems: 'stretch' }}>
          ...
          >
            <Box sx={{
              width: '100%', minHeight: { xs: 'auto', lg: 500 },
              ...
              <Box sx={{ position: 'relative', zIndex: 1 }}>
                ...
                <Typography variant="h2" sx={{ color: '#ffffff', fontSize: { xs: '1.75rem', md: '2.1rem' }, fontWeight: 900, lineHeight: 1.2, letterSpacing: '-0.02em', mb: 2.5 }}>
                  Why Partner with{' '}
                  <Box component="span" sx={{ color: alpha(primary, 0.9) }}>Milta for Digital Marketing?</Box>
                </Typography>
                <Typography sx={{ color: alpha('#ffffff', 0.68), fontSize: '0.9rem', lineHeight: 1.8, mb: 4, fontFamily: '"Outfit", sans-serif' }}>
                  In today's competitive market, a strong online presence is crucial. Miltafs brings proven strategies, data-driven insights, and a full-service approach to grow your business online.
                </Typography>
