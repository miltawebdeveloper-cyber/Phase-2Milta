          ...
          <Box sx={{ flex: 1 }}>
            ...
            <motion.div {...fadeUp(0.1)}>
              <Typography variant="h2" sx={{ fontSize: { xs: '1.9rem', md: '2.8rem' }, lineHeight: 1.2, mb: 2.5 }}>
                ...
                <Box component="span" sx={{ color: primary }}>Digital Marketing Excellence in the USA</Box>
              </Typography>
            </motion.div>
            <motion.div {...fadeUp(0.18)}>
              ...
              <Typography sx={{ color: 'text.secondary', fontSize: '1rem', lineHeight: 1.85, fontFamily: '"Outfit", sans-serif', mb: 2 }}>
                Miltafs is a dynamic, versatile, and full-service digital marketing agency that doesn't rely on gimmicks to attract clients. Instead, we leverage our expertise in search engine optimization (SEO) and marketing to drive new customers to your business.
              </Typography>
              <Typography sx={{ color: 'text.secondary', fontSize: '1rem', lineHeight: 1.85, fontFamily: '"Outfit", sans-serif', mb: 3 }}>
                We are not a static company; we don't confine ourselves to specific industries. Miltafs has the experience and talent to build custom websites and utilize a variety of digital marketing services to assist businesses of all sizes across any sector. Explore the diverse range of digital marketing services that Miltafs offers. Please reach out to us today to discover how we can assist in the expansion of your business.
              </Typography>
              <Button
            ...
            <Box sx={{ position: 'relative', borderRadius: '24px', overflow: 'hidden', boxShadow: `0 32px 80px ${alpha(primary, 0.12)}` }}>
              ...
              <Box sx={{ position: 'absolute', bottom: 24, left: 24, right: 24, borderRadius: '16px', bgcolor: (t) => t.palette.mode === 'dark' ? 'rgba(25,42,27,0.95)' : 'rgba(255,255,255,0.95)', backdropFilter: 'blur(12px)', p: 2.5, boxShadow: '0 8px 32px rgba(0,0,0,0.12)' }}>
                <Stack direction="row" spacing={3} justifyContent="space-around">
                  {[{ num: '500+', label: 'Clients' }, { num: '50', label: 'States' }, { num: '10y+', label: 'Experience' }].map(({ num, label }) => (
