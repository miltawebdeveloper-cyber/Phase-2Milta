...
const ADVANTAGES = [
  { icon: AttachMoneyIcon,      title: 'Cost Savings',               desc: 'Save on recruitment, training, and employee benefits. Pay only for the services or hours you require — reducing operational costs without compromising quality.' },
  { icon: TrendingUpIcon,       title: 'Increased Productivity',     desc: 'Focus on your business\'s core operations while delegating repetitive tasks to experienced professionals who improve turnaround times with efficient handling.' },
  { icon: TuneIcon,             title: 'Flexibility and Scalability', desc: 'Adjust service levels to match your company\'s needs at any time. Adapt procedures and tasks to your requirements as your business evolves and grows.' },
  { icon: WorkspacePremiumIcon, title: 'Expert Support',             desc: 'Gain access to professionals proficient in accounting, bookkeeping, customer support, and more — trained in the latest tools and techniques for top-notch results.' },
];
            ...
            <Box sx={{
              ...
              <Box sx={{ position: 'relative', zIndex: 1 }}>
                ...
                <Typography variant="h2" sx={{ color: '#ffffff', fontSize: { xs: '1.75rem', md: '2.1rem' }, fontWeight: 900, lineHeight: 1.2, letterSpacing: '-0.02em', mb: 2.5 }}>
                  Why Professional{' '}
                  <Box component="span" sx={{ color: alpha(primary, 0.9) }}>Virtual Assistance</Box>{' '}
                  Matters
                </Typography>

                <Typography sx={{ color: alpha('#ffffff', 0.68), fontSize: '0.9rem', lineHeight: 1.8, mb: 4, fontFamily: '"Outfit", sans-serif' }}>
                  Hiring a virtual assistant gives you expert support, reduced costs, and the freedom to focus entirely on growing your business.
                </Typography>
