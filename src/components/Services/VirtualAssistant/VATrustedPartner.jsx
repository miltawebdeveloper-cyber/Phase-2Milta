          ...
          <Box sx={{ textAlign: 'center', mb: { xs: 6, md: 8 } }}>
            ...
            <motion.div {...fadeUp(0.18)}>
              <Typography sx={{ color: alpha('#fff', 0.6), fontSize: '1rem', lineHeight: 1.8, maxWidth: 580, mx: 'auto', mt: 2, fontFamily: '"Outfit", sans-serif' }}>
                We stand out as a trusted partner for small businesses — delivering efficient, reliable, and confidential virtual assistant services tailored to your goals.
              </Typography>
            </motion.div>
...
export default VATrustedPartner;
