...
const POINTS = [
  ...
  'Get financial performance insights for strategic planning.',
  'Maintain compliance with financial and tax obligations.',
];
          ...
          <Box sx={{ flex: 1 }}>
            ...
            <motion.div {...fadeUp(0.1)}>
              <Typography variant="h2" sx={{ fontSize: { xs: '1.9rem', md: '2.8rem' }, lineHeight: 1.2, mb: 2.5 }}>
                What is a Bookkeeping Service and{' '}
            ...
            <motion.div {...fadeUp(0.18)}>
              ...
              <Typography sx={{ color: 'text.secondary', fontSize: '1rem', lineHeight: 1.85, fontFamily: '"Outfit", sans-serif', mb: 2 }}>
                Bookkeeping is the process of documenting, arranging, and overseeing a company's financial activities. It ensures your financial records are accurate, enabling better decision-making and compliance with legal and tax regulations.
              </Typography>
              <Typography sx={{ color: 'text.secondary', fontSize: '0.97rem', lineHeight: 1.85, fontFamily: '"Outfit", sans-serif', mb: 3, fontWeight: 600 }}>
                Regardless of size, bookkeeping is essential for every organization because:
              </Typography>
            </motion.div>
            <Stack spacing={1.5}>
              {POINTS.map((point, i) => (
