...
const industries = [
  { id: '01', icon: <Business sx={{ fontSize: { xs: 32, sm: 36, md: 40 }, color: 'primary.main' }} />, title: 'Contractors', desc: 'Expert bookkeeping for service contractors; track income, expenses, payroll, and taxes to keep your construction finances on point.', link: '/us/industries/contractors-companies/', image: 'https://images.unsplash.com/photo-1504307651254-35680f356dfd?auto=format&fit=crop&q=80&w=800', stat: 'Job Costing Pro', tag: 'CONSTRUCTION' },
  { id: '02', icon: <HomeWork sx={{ fontSize: { xs: 32, sm: 36, md: 40 }, color: 'primary.main' }} />, title: 'Real Estate', desc: 'We offer bookkeeping services for real estate. Book your free consultation today and simplify your property financial management.', link: '/us/industries/real-estate-companies/', image: 'https://images.unsplash.com/photo-1560518883-ce09059eeffa?auto=format&fit=crop&q=80&w=800', stat: 'Portfolio Optimized', tag: 'PROPERTY' },
  { id: '03', icon: <Factory sx={{ fontSize: { xs: 32, sm: 36, md: 40 }, color: 'primary.main' }} />, title: 'Manufacturing', desc: 'Milta provides accounting and bookkeeping services for manufacturing companies, handling the tracking of financial operations and ensuring compliance with tax laws and regulations..', link: '/us/industries/manufacturing-companies/', image: 'https://images.unsplash.com/photo-1581091226825-a6a2a5aee158?auto=format&fit=crop&q=80&w=800', stat: 'Cost Efficiency', tag: 'PRODUCTION' },
  { id: '04', icon: <LocalHospital sx={{ fontSize: { xs: 32, sm: 36, md: 40 }, color: 'primary.main' }} />, title: 'Healthcare', desc: 'Our specialized Accounting Services for Healthcare ensure accurate services for doctors, medical practices, and the healthcare industry.', link: '/us/industries/health-care-industry/', image: 'https://images.unsplash.com/photo-1576091160399-112ba8d25d1d?auto=format&fit=crop&q=80&w=800', stat: 'HIPAA Compliant', tag: 'MEDICAL' },
  { id: '05', icon: <VolunteerActivism sx={{ fontSize: { xs: 32, sm: 36, md: 40 }, color: 'primary.main' }} />, title: 'Non-Profit', desc: 'We provide accounting services for non-profit organizations, ensuring transparency and compliance with regulatory requirements.', link: '/us/industries/non-profit-organizations/', image: 'https://images.unsplash.com/photo-1488521787991-ed7bbaae773c?auto=format&fit=crop&q=80&w=800', stat: 'Fund Tracking', tag: 'CHARITY' },
  { id: '06', icon: <Restaurant sx={{ fontSize: { xs: 32, sm: 36, md: 40 }, color: 'primary.main' }} />, title: 'Restaurant', desc: 'We provide expert accounting and bookkeeping for small restaurant businesses to help you stay organized, compliant, and profitable.', link: '/us/industries/restaurant-industry/', image: 'https://images.unsplash.com/photo-1550966871-3ed3cdb5ed0c?auto=format&fit=crop&q=80&w=800', stat: 'Margin Control', tag: 'FOOD SERVICE' },
  { id: '07', icon: <Storefront sx={{ fontSize: { xs: 32, sm: 36, md: 40 }, color: 'primary.main' }} />, title: 'Retail Business', desc: 'We offer accounting services for retail businesses in the USA. Our services include expense tracking, cash flow monitoring, tax maintenance, and reporting.', link: '/us/industries/retail-business/', image: 'https://images.unsplash.com/photo-1441986300917-64674bd600d8?auto=format&fit=crop&q=80&w=800', stat: 'Inventory Pro', tag: 'RETAIL' },
];
