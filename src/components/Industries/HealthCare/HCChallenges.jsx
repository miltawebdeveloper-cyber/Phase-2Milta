...
const CHALLENGES = [
  { icon: ReceiptLongIcon, title: 'Complex Medical Billing',         desc: 'Multi-payer billing systems make accurate revenue tracking difficult without specialized healthcare accounting.' },
  { icon: PolicyIcon,      title: 'Insurance Reimbursements',        desc: 'Tracking and reconciling insurance claims and reimbursements demands precision and constant follow-up.' },
  { icon: GavelIcon,       title: 'Medicare & Medicaid Compliance',  desc: 'Reimbursement rules for Medicare and Medicaid require expert handling to stay compliant and maximize deductions.' },
  { icon: SecurityIcon,    title: 'Regulatory & HIPAA Compliance',   desc: 'Healthcare finances and data must meet strict regulatory and HIPAA-aligned standards at every step.' },
  { icon: ShowChartIcon,   title: 'Cash Flow Stability',             desc: 'Delayed payments and uneven income make maintaining liquidity a constant operational challenge.' },
  { icon: PaymentsIcon,    title: 'Payroll Complexity',              desc: 'Paying clinical and administrative staff accurately while staying compliant with labor and tax laws is demanding.' },
];
          ...
          <Box sx={{ flex: '0 0 auto', width: { xs: '100%', lg: 340 }, position: { lg: 'sticky' }, top: { lg: 80 } }}>
            ...
            <motion.div {...fadeUp(0.1)}>
              <Typography variant="h2" sx={{ fontSize: { xs: '2rem', md: '2.6rem' }, lineHeight: 1.18, mb: 2.5, letterSpacing: '-0.02em' }}>
                ...
                <Box component="span" sx={{ color: primary }}>Healthcare</Box>
              </Typography>
            </motion.div>
