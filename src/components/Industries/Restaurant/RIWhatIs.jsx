...
const TILES = [
  { icon: RestaurantMenuIcon, label: 'Daily Sales Tracking',      desc: 'Income categorized by meal, time slot, and service channel.' },
  { icon: Inventory2Icon,     label: 'Inventory & COGS Control',  desc: 'Track food costs and cut waste, down to the ounce.' },
  { icon: PaymentsIcon,       label: 'Tip & Payroll Compliance',  desc: 'Accurate tip reporting and wage-law compliance.' },
  { icon: CloudIcon,          label: 'POS & Cloud Integration',   desc: 'Syncs with your POS, payroll, and online ordering tools.' },
];

const STATS = [
  { num: '100%', label: 'Compliant'    },
  { num: '24/7', label: 'Cloud Access' },
  { num: 'POS',  label: 'Integrated'   },
];
          ...
          <Box>
            ...
            <motion.div {...fadeUp(0.18)}>
              <Typography sx={{ color: 'text.secondary', fontSize: '0.97rem', lineHeight: 1.88, fontFamily: '"Outfit", sans-serif', mb: 2 }}>
                Running a small restaurant is no easy task — you're balancing food quality, customer satisfaction, and daily operations. Disorganized financials cause stress, lead to mistakes, and prevent your business from seizing new opportunities. At Milta, we provide expert accounting and bookkeeping for small restaurant businesses to keep you organized, compliant, and profitable.
              </Typography>
            </motion.div>
            <motion.div {...fadeUp(0.24)}>
              <Typography sx={{ color: 'text.secondary', fontSize: '0.97rem', lineHeight: 1.88, fontFamily: '"Outfit", sans-serif', mb: 4 }}>
                Whether you manage a single-location café, a cozy diner, or a family-owned restaurant, our restaurant bookkeeping services ensure your books are accurate, your taxes are filed on time, and your business stays financially healthy.
              </Typography>
            </motion.div>
            ...
            <Box sx={{
              ...
              <Box sx={{ mb: 3, pb: 2.5, borderBottom: `1px solid ${alpha(primary, 0.12)}` }}>
                <Typography sx={{
                  ...
                  Why every small restaurant needs{' '}
