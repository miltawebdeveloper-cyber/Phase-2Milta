...
const CHALLENGES = [
  { icon: GroupsIcon,                    title: 'High Staff Turnover',        desc: 'We handle wage calculations, tip reporting, and tax withholdings accurately, even as your team changes.' },
  { icon: CalendarMonthIcon,             title: 'Seasonal Revenue',           desc: 'Milta offers planning tools that help small restaurant businesses stay profitable year-round.' },
  { icon: AutoModeIcon,                  title: 'Manual Bookkeeping Headaches', desc: 'Say goodbye to paper logs and spreadsheets — our digital solutions automate your restaurant bookkeeping.' },
  { icon: IntegrationInstructionsIcon,   title: 'Multiple Systems',           desc: 'We integrate with your POS, payroll tools, and online ordering systems for seamless financial tracking.' },
];
          ...
          <Box sx={{ flex: '0 0 auto', width: { xs: '100%', lg: 340 }, position: { lg: 'sticky' }, top: { lg: 80 } }}>
            ...
            <motion.div {...fadeUp(0.1)}>
              <Typography variant="h2" sx={{ fontSize: { xs: '2rem', md: '2.6rem' }, lineHeight: 1.18, mb: 2.5, letterSpacing: '-0.02em' }}>
                ...
                <Box component="span" sx={{ color: primary }}>for Small Restaurants</Box>
              </Typography>
            </motion.div>
