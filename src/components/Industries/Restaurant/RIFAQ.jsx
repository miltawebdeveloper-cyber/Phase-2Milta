...
const FAQS = [
  ...
  {
    q: "What's included in your restaurant tax preparation services?",
    a: 'Our services include detailed tax return filing, year-end financial reporting, deduction optimization (including tips, payroll, and food costs), and proactive tax planning strategies.',
  },
  {
    q: 'How do you ensure accuracy in year-end reports for restaurants?',
    a: 'We reconcile income, expenses, inventory, vendor payments, and payroll using restaurant-focused accounting tools to deliver precise and IRS-compliant year-end reporting.',
  },
  {
    q: 'Can Milta manage quarterly estimated tax payments for restaurant businesses?',
    a: 'Absolutely. We calculate and schedule estimated quarterly payments to help your restaurant avoid IRS penalties and better manage seasonal cash flow fluctuations.',
  },
  {
    q: 'When should I begin tax planning for my restaurant business?',
    a: 'Preparation for taxes should start early and last all year. This allows us to identify deductions, plan around peak seasons, and ensure accurate records for smooth year-end filing.',
  },
];
