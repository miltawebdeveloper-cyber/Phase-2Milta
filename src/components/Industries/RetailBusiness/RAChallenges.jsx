...
const CHALLENGES = [
  { icon: CalendarMonthIcon,     title: 'Seasonal Sales Trends',   desc: 'We help you manage financial fluctuations during holiday peaks and off-seasons.' },
  { icon: Inventory2Icon,        title: 'Inventory Valuation',     desc: 'We handle valuation using FIFO, LIFO, or weighted-average methods while addressing obsolescence and spoilage.' },
  { icon: HubIcon,               title: 'Multi-Channel Complexity', desc: 'We consolidate data from your POS, online store, and mobile platforms into one unified financial picture.' },
  { icon: AssignmentReturnIcon,  title: 'Customer Returns & Refunds', desc: 'Accurate handling of returns, refunds, and restocks is built right into our bookkeeping workflows.' },
];
          ...
          <Box sx={{ flex: '0 0 auto', width: { xs: '100%', lg: 340 }, position: { lg: 'sticky' }, top: { lg: 80 } }}>
            ...
            <motion.div {...fadeUp(0.1)}>
              <Typography variant="h2" sx={{ fontSize: { xs: '2rem', md: '2.6rem' }, lineHeight: 1.18, mb: 2.5, letterSpacing: '-0.02em' }}>
                Retail Bookkeeping Challenges{' '}
                <Box component="span" sx={{ color: primary }}>We Solve</Box>
              </Typography>
            </motion.div>
