...
const TILES = [
  { icon: PointOfSaleIcon, label: 'Multi-Channel Sales Tracking', desc: 'POS, online, and mobile sales unified in one view.' },
  { icon: Inventory2Icon,  label: 'Inventory Valuation',         desc: 'FIFO, LIFO, or weighted-average — with obsolescence handled.' },
  { icon: GavelIcon,       label: 'Tax-Ready Compliance',        desc: 'Federal and state requirements met, year-round.' },
  { icon: CloudIcon,       label: 'Secure & Cloud-Based',        desc: 'Encrypted tools with anytime, anywhere access.' },
];

const STATS = [
  { num: '100%', label: 'Compliant'    },
  { num: '24/7', label: 'Cloud Access' },
  { num: 'Multi', label: 'Channel'     },
];
          ...
          <Box>
            ...
            <motion.div {...fadeUp(0.18)}>
              <Typography sx={{ color: 'text.secondary', fontSize: '0.97rem', lineHeight: 1.88, fontFamily: '"Outfit", sans-serif', mb: 2 }}>
                In today's competitive retail environment, effective bookkeeping is more than a best practice — it's essential for growth, profitability, and compliance. From traditional storefronts to e-commerce and hybrid models, every retail business needs accurate financial records to make informed decisions, manage inventory, and stay compliant with tax laws.
              </Typography>
            </motion.div>
