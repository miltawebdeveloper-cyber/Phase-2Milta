...
const CHALLENGES = [
  { icon: ListAltIcon,        title: 'Create a Custom Chart of Accounts',       desc: 'Build a chart of accounts customized to reflect real estate-specific income and expense categories.' },
  { icon: AttachMoneyIcon,    title: 'Record Income Promptly',                  desc: 'From rent collections to consulting fees, record every income source as soon as it comes in.' },
  { icon: ReceiptLongIcon,    title: 'Track Operating Expenses',                desc: 'Categorize and regularly review insurance, maintenance, utilities, taxes, and loan payments.' },
  { icon: ShowChartIcon,      title: 'Monitor Cash Flow Consistently',          desc: 'Stay liquid and make sound investment decisions by watching cash flow closely.' },
  { icon: AccountBalanceIcon, title: 'Do Monthly Bank Reconciliations',         desc: 'Match your bank and book records every month to avoid costly discrepancies.' },
  { icon: AssessmentIcon,     title: 'Prepare & Analyze Financial Statements',  desc: 'Review profit and loss, balance sheets, and cash flow reports regularly.' },
  { icon: EventRepeatIcon,    title: 'Close Books Monthly or Quarterly',        desc: 'Stay prepared for tax season and avoid last-minute, end-of-year chaos.' },
];
          ...
          <Box sx={{ flex: '0 0 auto', width: { xs: '100%', lg: 340 }, position: { lg: 'sticky' }, top: { lg: 80 } }}>
            ...
            <motion.div {...fadeUp(0.1)}>
              <Typography variant="h2" sx={{ fontSize: { xs: '2rem', md: '2.6rem' }, lineHeight: 1.18, mb: 2.5, letterSpacing: '-0.02em' }}>
                Bookkeeping Tips for{' '}
                <Box component="span" sx={{ color: primary }}>Real Estate Pros</Box>
              </Typography>
            </motion.div>
            <motion.div {...fadeUp(0.18)}>
              ...
              <Typography sx={{ color: 'text.secondary', fontSize: '0.95rem', lineHeight: 1.82, fontFamily: '"Outfit", sans-serif', mb: 4 }}>
                Follow these best practices from our real estate accounting services for cleaner financials, better tax outcomes, and improved operational efficiency.
              </Typography>
            </motion.div>
            ...
            <motion.div {...fadeUp(0.26)}>
              <Box sx={{
                ...
                <Typography sx={{ fontFamily: '"Outfit", sans-serif', fontWeight: 600, fontSize: '0.82rem', color: 'text.secondary', textTransform: 'uppercase', letterSpacing: '0.06em' }}>
                  Best practices to keep your books clean and tax-ready
                </Typography>
              </Box>
            </motion.div>
          </Box>
