...
const navItems = [
  ...
  { label: 'Industry', path: '/industry',
    children: [
      { label: 'Contractor Companies',   path: '/us/industries/contractors-companies/' },
      { label: 'Law Firms',              path: '/us/industries/law-firms/' },
      { label: 'Manufacturing Companies', path: '/us/industries/manufacturing-companies/' },
      { label: 'Real Estate Companies',   path: '/us/industries/real-estate-companies/' },
      { label: 'Non-Profit Organizations', path: '/us/industries/non-profit-organizations/' },
      { label: 'Health Care Industry',     path: '/us/industries/health-care-industry/' },
      { label: 'Restaurant Industry',      path: '/us/industries/restaurant-industry/' },
      { label: 'Retail Business',          path: '/us/industries/retail-business/' },
    ],
  },
...
const DARK_HERO_PATHS = [
  ...
  '/us/industries/contractors-companies/',
  '/us/industries/law-firms/',
  '/us/industries/manufacturing-companies/',
  '/us/industries/real-estate-companies/',
  '/us/industries/non-profit-organizations/',
  '/us/industries/health-care-industry/',
  '/us/industries/restaurant-industry/',
  '/us/industries/retail-business/',
