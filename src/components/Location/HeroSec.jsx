...
const HeroSec = ({
  ...
  return (
    ...
    >
      ...
      <Container
        maxWidth={false}
        sx={{ maxWidth: "1300px", mx: "auto", position: "relative", zIndex: 1 }}
      >
        <Box
          sx={{
            display: "flex",
        ...
        >
          ...
          >
            <Breadcrumbs
              separator={
                <NavigateNextIcon sx={{ fontSize: 16, color: alpha("#ffffff", 0.5) }} />
              }
              sx={{
                mb: 3,
                "& .MuiBreadcrumbs-ol": {
